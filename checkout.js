...
const copyDeliveryStateAndRegion = () => {
  let country = document.getElementById("EcomOrderDeliveryCountry").value;
  let state = document.getElementById("EcomOrderDeliveryRegion").value;
  
  getDataJSON(country)
    .then((data) => {
      document.getElementById("EcomOrderCustomerCountry").value = country;      
      return new Promise((resolve, reject)=>{
        resolve(data);
      });
    })
    ...
    .then((data) => {
      document.getElementById("EcomOrderCustomerRegion").value = state;
      return new Promise((resolve, reject)=>{
        resolve(data);
      });
    })
